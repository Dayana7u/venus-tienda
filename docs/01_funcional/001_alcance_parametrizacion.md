...
## Estado actual del bloque administrativo
- Parametrización se mantiene como módulo CRUD base.
- Seguridad se maneja como módulo separado dentro del mismo panel administrativo.
- La navegación administrativa se centra en dos opciones: `Parametrización` y `Seguridad`.
- El cambio de claves administrativas se realiza desde seguridad y las claves quedan almacenadas con hash.
