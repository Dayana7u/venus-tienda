...
tienda_admin_render_head('Admin tienda - Pagos');
tienda_admin_render_layout_inicio($tda_pagina_activa, 'Admin tienda', 'Módulo comercial para revisar transacciones registradas, referencias y estados del pago.');
?>
